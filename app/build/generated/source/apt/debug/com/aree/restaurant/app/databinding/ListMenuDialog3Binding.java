...
public class ListMenuDialog3Binding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ll_SeaFood, 6);
        ...
        sViewsWithIds.put(R.id.ll_GeneralFood, 12);
        ...
        sViewsWithIds.put(R.id.ll_Snack, 18);
        ...
        sViewsWithIds.put(R.id.ll_Beverage, 24);
    ...
    @NonNull
    public final android.widget.LinearLayout llBeverage;
    @NonNull
    public final android.widget.LinearLayout llGeneralFood;
    @NonNull
    public final android.widget.LinearLayout llSeaFood;
    @NonNull
    public final android.widget.LinearLayout llSnack;
    @NonNull
    ...
    public ListMenuDialog3Binding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.llBeverage = (android.widget.LinearLayout) bindings[24];
        this.llGeneralFood = (android.widget.LinearLayout) bindings[12];
        this.llSeaFood = (android.widget.LinearLayout) bindings[6];
        this.llSnack = (android.widget.LinearLayout) bindings[18];
    ...
    @NonNull
    public static ListMenuDialog3Binding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static ListMenuDialog3Binding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ListMenuDialog3Binding>inflate(inflater, com.aree.restaurant.app.R.layout.list_menu_dialog3, root, attachToRoot, bindingComponent);
    }
    @NonNull
    public static ListMenuDialog3Binding inflate(@NonNull android.view.LayoutInflater inflater) {
        return inflate(inflater, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static ListMenuDialog3Binding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.aree.restaurant.app.R.layout.list_menu_dialog3, null, false), bindingComponent);
    }
    @NonNull
    public static ListMenuDialog3Binding bind(@NonNull android.view.View view) {
        return bind(view, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static ListMenuDialog3Binding bind(@NonNull android.view.View view, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        if (!"layout/list_menu_dialog3_0".equals(view.getTag())) {
            throw new RuntimeException("view tag isn't correct on view:" + view.getTag());
        }
        return new ListMenuDialog3Binding(bindingComponent, view);
    }
    /* flag mapping
        flag 0 (0x1L): null
    flag mapping end*/
